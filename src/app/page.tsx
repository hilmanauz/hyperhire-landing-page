          ...
          <div className="flex gap-x-20">
            <div className="space-y-7 text-white w-[50%]">
              <ScrollAnimation animateIn="fadeInUp" duration={0.5}>
                <h2
                  id="banner-text"
                  className="text-5xl/[62.4px] font-extrabold whitespace-pre-line">{`최고의 실력을 가진
             외국인 인재를 찾고 계신가요?`}</h2>
              </ScrollAnimation>
              <ScrollAnimation animateIn="fadeIn" duration={0.5} delay={800}>
                <Tooltip offset={20} anchorSelect="#banner-text" isOpen place="top-start" classNameArrow="!left-3">
                  <span className="text-[#40E2E8] text-lg">풀타임, 파트타임</span>
                </Tooltip>
              </ScrollAnimation>
              <ScrollAnimation animateIn="fadeInUp" duration={0.5}>
            ...
            <ScrollAnimation animateIn="fadeIn" duration={0.5} className="flex flex-1">
